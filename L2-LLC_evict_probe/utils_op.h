...
// 左右两个方向的全部统计
    // cha_perfevtsel[0] = 0x00400fab;		// HORZ_RING_BL_IN_USE.LEFT.right
    // cha_perfevtsel[1] = 0x004005ad;		// HORZ_RING_IV_IN_USE.LEFT.right
	// cha_perfevtsel[2] = 0x00400fa7;		// HORZ_RING_AD_IN_USE.RIGHT.left
	// cha_perfevtsel[3] = 0x00400fa9;		// HORZ_RING_AK_IN_USE.RIGHT.left
    ...
    // cha_perfevtsel[2] = 0x004001ad;		// HORZ_RING_IV_IN_USE.LEFT
	// cha_perfevtsel[3] = 0x004004ad;		// HORZ_RING_IV_IN_USE.RIGHT

    // cha_perfevtsel[0] = 0x014003ab;		// HORZ_RING_BL_IN_USE.LEFT
	// cha_perfevtsel[1] = 0x01400cab;		// HORZ_RING_BL_IN_USE.RIGHT
	// // cha_perfevtsel[2] = 0x004003aa;		// VERT_RING_BL_IN_USE.UP
	// // cha_perfevtsel[3] = 0x00400caa;		// VERT_RING_BL_IN_USE.DN
    // cha_perfevtsel[2] = 0x014001ad;		// HORZ_RING_IV_IN_USE.LEFT
	// cha_perfevtsel[3] = 0x014004ad;		// HORZ_RING_IV_IN_USE.RIGHT
	...
	//cha_perfevtsel[2] = 0x0040af37;		// LLC_VICTIMS.TOTAL (MESF) (does not count clean victims)
    // cha_perfevtsel[2] = 0x00400334;		// LLC_LOOKUP.DATA_READ	<-- requires CHA_FILTER0[26:17]
...
void print_cha_counters(){
    puts("MONITING USING PMON");
    // puts("----Original----");
